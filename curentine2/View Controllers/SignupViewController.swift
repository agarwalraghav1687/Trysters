...
class SignupViewController: UIViewController {
    ...
    func transitionTopic()
    {
        let picviewcontroller = storyboard?.instantiateViewController(withIdentifier: Constants.Storyboard.picUpload) as? picUpload
        
        view.window?.rootViewController = picviewcontroller
